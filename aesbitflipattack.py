...
#   Description: Purpose of this script is the proof of concept for the revalidation of an expired ticket 
#   in order to get authenticated. In this scenario, the ticket that gives the authorization for a change 
